...
from utils import generate_resume, save_feedback, get_templates, html_to_pdf, html_to_docx
import os
...
if st.button("Generate Resume"):
    if not name or not email:
        ...
        if enable_job_match and job_desc:
            st.success(f"Resume matches {ats_score:.2f}% of the job description keywords.")
